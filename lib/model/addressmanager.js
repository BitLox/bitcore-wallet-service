...
AddressManager.create = function(opts) {
  ...
  console.log("create new address manager")
...
AddressManager.fromObj = function(obj) {
  var x = new AddressManager();
  console.log("FROM OBJ: " +JSON.stringify(obj))
...
AddressManager.prototype._incrementIndex = function(isChange) {
  ...
  console.log("incchange"+this.changeAddressIndex)
  console.log("inc"+this.receiveAddressIndex)
};
...
AddressManager.prototype.rewindIndex = function(isChange, n) {
  ...
  console.log("rewindchange"+this.changeAddressIndex)
  console.log("rewind"+this.receiveAddressIndex)
};
